...
import {verificationMessage} from "../markup/verification-message.js";
import {postConfirmationLambda} from "./cognito/post-confirmation.js";


/**
 * UserPool
 */
export const userPool = new aws.cognito.UserPool('main-users', {
    deviceConfiguration: {
...
const userPoolClient = new aws.cognito.UserPoolClient('main-client', {
    ...
    logoutUrls: [
        ...
        'https://develop.d3bft3p6tuw3e.amplifyapp.com/signout',
        'https://main.d3bft3p6tuw3e.amplifyapp.com/signout'
    ],
